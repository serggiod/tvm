angular.module('application').controller('TvMsgCtrl',function($scope,$http,$window,SessionFac,TvMsgSvc){
    ...
    $scope.init=function(){
        SessionFac.sessionStatus(function(){
            ...
            $scope.titulo='Administrar Tv-Msg';
    ...
    $scope.resetModel=function(){
        TvMsgSvc.id=null;
        TvMsgSvc.back_color=null;
        TvMsgSvc.play_direction=null;
        TvMsgSvc.play_time=null;
        TvMsgSvc.m=null;
    };
    ...
    $scope.resetRegisters=function(){
        TvMsgSvc.m='registers';
